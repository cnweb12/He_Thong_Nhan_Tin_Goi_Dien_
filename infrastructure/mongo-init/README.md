...
kết nối để test root account từ host vào qua url sau
mongodb://<tên tài khoản>:<mật khẩu>@127.0.0.1:27018/?authSource=admin&directConnection=true
...
```text
mongodb://chat_app_user:chat_app_password@localhost:27018/chat_app?authSource=chat_app
```
