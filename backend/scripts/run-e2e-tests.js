...
try {
  ...
  execSync(
    "docker compose -f docker-compose.yml -f docker-compose.dev.yml up -d --wait mongo",
    {
      stdio: "inherit",
      cwd: rootDir,
    },
  ...
  console.error(
    "❌ Test thất bại hoặc có lỗi xảy ra trong quá trình thực thi.",
  );
  ...
  try {
    execSync(
      "docker compose -f docker-compose.yml -f docker-compose.dev.yml down mongo",
      {
        stdio: "inherit",
        cwd: rootDir,
      },
