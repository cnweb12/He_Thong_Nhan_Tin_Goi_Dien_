    ...
    return (
        <div className="h-[76px] flex items-center justify-between px-5 border-b border-slate-200 bg-white/85 backdrop-blur shadow-[0_1px_0_rgba(15,23,42,0.03)]">
            ...
            <div className="flex items-center gap-2 text-slate-600">
                <button className="p-2.5 rounded-full hover:bg-slate-100"><Search size={18} /></button>
                <button className="p-2.5 rounded-full hover:bg-slate-100"><Phone size={18} /></button>
                <button className="p-2.5 rounded-full hover:bg-slate-100"><Video size={18} /></button>
                <button className="p-2.5 rounded-full hover:bg-slate-100"><Info size={18} /></button>
                <button className="p-2.5 rounded-full hover:bg-slate-100"><MoreVertical size={18} /></button>
            </div>
        </div>
    );
}