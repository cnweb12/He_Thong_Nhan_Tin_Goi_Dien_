...
export default function MessageList({ messages, currentUserId, loading, error, chat, typingUsers = [], onRecallMessage }) {
            ...
            <div className="max-w-3xl mx-auto space-y-2 pb-4">
                ...
                {validMessages.map((m, idx) => {
                    ...
                    if (!isMine || m.status === 'read') {
                        ...
                        const hasNewerWatermark = validMessages.slice(idx + 1).some(
